...
<html>
    ...
    <body>
        <div class="container">
            ...
            <a href="addProductServlet" class="add-btn">
        ...
        <table>
            ...
            <c:forEach items="${data}" var="p">
                <tr>
                    ...
                    <td>
                        <a href="editProductServlet?PID=${p.PID}" class="btn btn-edit">
                            <i class="fas fa-edit"></i> Sửa
                        </a>
                        <a href="deleteProductServlet?PID=${p.PID}" class="btn btn-delete"
